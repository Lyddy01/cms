...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="https://lydiacms.000webhostapp.com/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="https://lydiacms.000webhostapp.com/css/blog-post.css" rel="stylesheet">
...
ini_set('display_startup_errors', 0);
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="https://lydiacms.000webhostapp.com/index.php">Boomerang</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <?php 
                    if(!isset($_SESSION['name'])){
                        ...
                        echo "
                        <li>
                        <a href='https://lydiacms.000webhostapp.com/login.php'>Login</a>
                    </li>";
                    }else{

                        echo "
                        <li>
                        <a href='https://lydiacms.000webhostapp.com/logout.php'>Logout</a>
                    </li>";
                    }
        ...
        <div class="row">
            ...
            //   $posts->updateViews($_GET['id']);
                ...
                if($allPosts['type'] === "ApiPosts"){
                    ...
                    echo"<img class='img-responsive' src='https://lydiacms.000webhostapp.com/admin/images/$allPosts[image]' alt=''>";
                }
                ...
                <div class="well">
                    ...
                    <form role="form" method="POST">
                        ...
                        if(!isset($_SESSION['name'])){
                            ...
                            echo "<a href='https://lydiacms.000webhostapp.com/login.php?redirect=$page&&id=$_GET[id]&&title=$_GET[title]' class='btn btn-primary'>Login to continue</a>";
  ...
  ?>
    ...
    <!-- jQuery -->
    <script src="https://lydiacms.000webhostapp.com/js/jquery.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="https://lydiacms.000webhostapp.com/js/bootstrap.min.js"></script>
